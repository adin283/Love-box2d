...
(function() {
  ...
  function genDot(color, className, ctx) {
    ...
    h.src = './images/' + className.replace(/\s.*?$/, '') + '-' + color +
        '.png';
    ctx.appendChild(h);
    return h;
  }
  ...
  function getDigits() {
    ...
    var dateDiff = Math.floor((now - countdownTo) / 1000);
    /**
   ...
   */
  var countdownTo = new Date(2009, 10, 6).getTime();
  ...
  countdownConfigs.push({
    gravity: { x: 0, y: 400 },
    colors: ['265897', '265897', '265897', '265897', '',
             '13acfa', '13acfa', '',
             'c0000b', 'c0000b', '',
             '009a49', '009a49'],
    dotType: 'ball',
